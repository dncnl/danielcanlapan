  ...
  return (
    <React.Fragment>
      <section id="top" style={{ position: 'relative', overflow: 'hidden', padding: 'clamp(56px,7vw,104px) var(--page-pad-x) clamp(40px,5vw,72px)' }}>
        <Orb style={{ position: 'absolute', right: '-22%', top: '-46%', opacity: 0.85 }} />
        <div style={{ position: 'relative', maxWidth: 'var(--max-w)', margin: '0 auto' }}>
          ...
          <Reveal delay={120}>
            <p style={{ marginTop: 'var(--space-6)', maxWidth: '58ch', fontSize: 'var(--fs-md)', lineHeight: 'var(--lh-body)', letterSpacing: 'var(--tracking-none)', color: 'var(--text-muted)' }}>
              Fourth-year computer science student and DOST-SEI scholar. I work across web apps and APIs,
              machine learning and data analysis, desktop interfaces, and the documentation that keeps a
              system legible — from the problem statement to the shipped screen.
            </p>
          </Reveal>
          <Reveal delay={180}>
          ...
          <Reveal delay={240}>
            <dl style={{
              ...
              {[['B.S. Computer Science', '4th year · expected 2027'], ['DOST-SEI Scholar', 'RA 7687 · 2023–present'], ['4 core competencies', 'web · ML · UI · docs'], ['Based in Pampanga, PH', 'GMT+8']].map(([t, d]) => (
                <div key={t}>
      ...
      <SkillMarquee items={window.SKILLS_A} speed={46} />
      <SkillMarquee items={window.SKILLS_B} speed={62} direction="right" style={{ borderTop: 0 }} />
    </React.Fragment>
  );
}
